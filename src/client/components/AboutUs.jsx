    ...
    <div className="bdy">
      <div className="about">
        <div className="inner-section">
          ...
          <p className="text">
            Welcome to Help Harbor, a nonprofit beacon of compassion and
            collaboration in the world of philanthropy. At Help Harbor, our
            mission is simple yet profound: to bridge the gap between charitable
            organizations in need and individuals eager to make a difference. We
            provide a unique platform where charities can post their specific
            requests for assistance. Our website serves as a virtual harbor,
            where these heartfelt pleas dock, waiting to catch the attention of
          ...
          <p className="text">
            We're a tight-knit crew of software developers fresh out of Full
            Stack Academy's rigorous Software Developer immersive bootcamp. Our
            squad is made up of passionate individuals who collaborated
